...
def main():
    ...
    print("""
  ######################################
  # ABC Development Environment Setup #
  ######################################

  This script will create your ABC dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ABC project folder:
    [Arma 3 installation directory]\\{} => ABC project folder
    P:\\{}                              => ABC project folder
